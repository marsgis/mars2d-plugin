...
export function init(map, widgetcfg = {}, _basePath = "") {
  ...
  if (isdebuger) {
    let inhtml =
      '<div id="widget-testbar" class="mars2d-widgetbar animation-slide-bottom no-print-view" > ' +
...
export function getDefWindowOptions() {
  return mars2d.Util.clone(defoptions.windowOptions, removeKeys);
}
...
//事件相关
export let eventTarget = new mars2d.BaseClass();
