...
let BaseClass = mars2d.BaseClass;
  ...
  _openWindow(viewopt) {
    ...
    let opts = {
      ...
      success: (layero, index) => {
        ...
        viewWindow.mars2d = mars2d;
        viewWindow.L = mars2d.L;
        ...
        if (viewWindow && viewWindow.initWidgetView) {
          ...
          mars2d.Log.logError(view_url + "页面没有定义function initWidgetView(widget)方法，无法初始化widget页面!");
        }
      },
    };
